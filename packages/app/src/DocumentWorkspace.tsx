...
export function DocumentWorkspace({
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto min-h-full max-w-[min(108rem,95vw)]">
        {documentPage ? (
          <div
            data-testid="document-page-header"
            className={cn(
              "document-page-shell mb-2 flex flex-col gap-6 text-[0.62rem] font-medium tracking-[0.01em] text-stone-400 min-[1100px]:grid min-[1100px]:grid-cols-[minmax(0,1fr)_minmax(20rem,24rem)] min-[1100px]:items-start min-[1100px]:justify-between min-[1100px]:gap-8",
              !documentHasComments &&
